...
wget_check "python"       "https://docs.python.org/3/"                            "Python 3.14.3 documentation"
...
wget_check "charset"      "https://pypi.org/project/charset-normalizer"           "charset-normalizer-3.4.6"
wget_check "jsonpath"     "https://pypi.org/project/python-jsonpath"              "python_jsonpath-2.0.2.tar.gz"
wget_check "idna"         "https://pypi.org/project/idna"                         "idna 3.11"
wget_check "requests"     "https://pypi.org/project/requests"                     "requests-2.33.0"
wget_check "urllib3"      "https://pypi.org/project/urllib3"                      "urllib3 2.6.3"
